...
export default function PlaygroundChurn() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-8">
          ...
          <div className="flex flex-col items-center gap-3">
            {showWarning && (
              <div className="flex items-center gap-2 text-amber-400 text-sm">
                ...
                <span>First time it may take 30-40 seconds to respond</span>
              </div>
            )}
            <button
      ...
      {result && (
        <div ref={resultRef} className="mx-auto mt-6 w-full max-w-5xl overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950 shadow-2xl">
