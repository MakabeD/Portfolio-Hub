...
export default function ProjectCard({
  ...
  return (
    <Link href={`/projects${href}`} className="block w-full no-underline">
      <article
        ref={cardRef}
      ...
      >
        ...
        <div className="relative z-10 flex flex-col gap-2">
          ...
          <small className="font-mono text-xs tracking-wider text-zinc-500">
            TYPE:{" "}
            <strong className="font-semibold text-zinc-300">{type}</strong>
          </small>
